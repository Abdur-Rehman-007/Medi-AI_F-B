...
import '../../faculty/dashboard/faculty_dashboard_controller.dart';
  ...
  Future<void> bookAppointment() async {
    ...
    try {
      ...
      if (response.success) {
        ...
        if (Get.isRegistered<FacultyDashboardController>()) {
          await Get.find<FacultyDashboardController>().refresh();
        }
