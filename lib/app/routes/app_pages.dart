...
import '../modules/faculty/medicine_reminders/faculty_medicine_reminders_screen.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(
      name: AppRoutes.facultyMedicineReminders,
      page: () => const FacultyMedicineRemindersScreen(),
      binding: FacultyMedicineRemindersBinding(),
    ),
