...
class AuthService extends GetxService {
  ...
  Future<void> _saveAuthData(Map<String, dynamic> data) async {
    // Handle backend response format: {token, userId, role}
    ...
    // Handle backend user data
    if (data.containsKey('userId') && data.containsKey('role')) {
      ...
      final user = User(
        ...
        cmsId: data['registrationNumber'] ?? data['cmsId'],
